...
export const mockCategories: Category[] = [
  { id: "c1", name: "Elektronik", iconName: "electronics", imageUrl: null },
  { id: "c2", name: "Kozmetik, Kişisel Bakım", iconName: "personal-care", imageUrl: null },
  { id: "c3", name: "Süpermarket", iconName: "grocery", imageUrl: null },
  { id: "c4", name: "Ev, Ofis, Yaşam", iconName: "home", imageUrl: null },
  { id: "c5", name: "Anne, Bebek, Oyuncak", iconName: "baby", imageUrl: null },
  { id: "c6", name: "Yapı Market, Oto, Bahçe", iconName: "automotive", imageUrl: null },
  { id: "c7", name: "Hobi, Kitap, Müzik", iconName: "office", imageUrl: null },
  { id: "c8", name: "Spor, Outdoor", iconName: "sports", imageUrl: null },
];
...
export function getProductListParams(mode: ProductListMode): { title: string; mode: ProductListMode } {
  switch (mode) {
    ...
    case "search":
      return { title: "Arama sonuçları", mode };
    default:
